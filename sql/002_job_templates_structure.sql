...
-- Evidence-Based Evaluation System Tables
-- These tables support the continuous feedback approach

-- Growth Evidence Entries (feedback from managers to employees)
CREATE TABLE IF NOT EXISTS growth_evidence_entries (
...
-- Media attachments for evidence entries (images, documents, etc.)
...
-- Evidence evaluation results (aggregated data for evaluations)
CREATE TABLE IF NOT EXISTS evidence_evaluation_results (
...
-- Evidence aggregations (statistics for employee performance over time)
